<?php
/*
Plugin Name: Footboo Info Puller
...
function footbo_puller($attrib){
  ...
  if(!empty($resp)) {
  	...
  	if($attrib['type'] == 'fixture')
        return '<div class="footbo_fixture">' . $resp . '</div>';
    if($attrib['type'] == 'fixture_all') 
        return '<div class="footbo_fixture_all">' . implode('',$resp) . '</div>';
  }
  else
